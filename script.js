...
let change = document.querySelector("label .change_color_input");
let labelChange = document.querySelector("label.change_color");

document.addEventListener("input", function () {
  let changeColor = change.value;

  labelChange.style.backgroundColor = changeColor;
